...
> & {
  ...
  const triggerState = React.useContext(TooltipTriggerStateContext)
  const content = (
    <TooltipPrimitive
  ...
  // This React Aria version requires trigger context inside TooltipInner,
  // including when a controlled tooltip supplies its own triggerRef.
  if (!triggerState) {
    return (
      <TooltipTriggerPrimitive
        isOpen={props.isOpen}
